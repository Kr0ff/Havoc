...
/* [HVC-002 2026-03-26] RFC 4648 base64 encode/decode. See TrafficImprovements.md §2. */
VOID Base64Encode( _In_ PUCHAR Input, _In_ SIZE_T InputLen, _Out_ PVOID *OutBuf, _Out_ PSIZE_T OutLen );
VOID Base64Decode( _In_ PUCHAR Input, _In_ SIZE_T InputLen, _Out_ PVOID *OutBuf, _Out_ PSIZE_T OutLen );
