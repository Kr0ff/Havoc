...
const (
	COMMAND_LATERAL = 2600
	COMMAND_PERSIST = 2610
	COMMAND_CREDS   = 2620
	COMMAND_PRIVESC = 2630

	DEMON_LATERAL_WMI_EXEC  = 1
	DEMON_LATERAL_DCOM_EXEC = 2

	DEMON_PERSIST_REG     = 1
	DEMON_PERSIST_SCHTASK = 2
	DEMON_PERSIST_COM     = 3
	DEMON_PERSIST_REMOVE  = 4

	DEMON_PERSIST_REMOVE_REG     = 1
	DEMON_PERSIST_REMOVE_SCHTASK = 2
	DEMON_PERSIST_REMOVE_COM     = 3

	DEMON_CREDS_LSASS = 1
	DEMON_CREDS_SAM   = 2

	DEMON_PRIVESC_UAC                  = 1
	DEMON_PRIVESC_UAC_FODHELPER        = 1
	DEMON_PRIVESC_UAC_COMPUTERDEFAULTS = 2
	DEMON_PRIVESC_UAC_EVENTVWR         = 3
